...
I went on board the ship Dorothy, John Bedford, commander, bound for Bristol;
...
and on the 16th went on board the ship Reserve, John Nicholson, master, bound for Dublin,
in Ireland,
